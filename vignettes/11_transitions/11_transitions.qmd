...
The next vignette in the CategoricalProjectionModels.jl package extends this idea to **valued projection nets**, which combine categorical structure with sparse numeric data.
